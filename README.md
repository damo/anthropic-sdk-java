...
[![Maven Central](https://img.shields.io/maven-central/v/com.anthropic/anthropic-java)](https://central.sonatype.com/artifact/com.anthropic/anthropic-java/0.1.0-alpha.4)
...
```kotlin
implementation("com.anthropic:anthropic-java:0.1.0-alpha.4")
```
