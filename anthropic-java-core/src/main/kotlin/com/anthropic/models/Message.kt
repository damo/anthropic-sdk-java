...
private constructor(
    ...
    class Builder {
         ...
         * ```
         */
        fun addContent(textBlock: TextBlock) = addContent(ContentBlock.ofTextBlock(textBlock))
         ...
         * ```
         */
        fun addContent(toolUseBlock: ToolUseBlock) =
            addContent(ContentBlock.ofToolUseBlock(toolUseBlock))
