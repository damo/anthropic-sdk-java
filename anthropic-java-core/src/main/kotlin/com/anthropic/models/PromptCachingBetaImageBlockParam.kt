...
@JsonDeserialize(builder = PromptCachingBetaImageBlockParam.Builder::class)
@NoAutoDetect
class PromptCachingBetaImageBlockParam
private constructor(
    ...
    fun validate(): PromptCachingBetaImageBlockParam = apply {
        if (!validated) {
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(promptCachingBetaImageBlockParam: PromptCachingBetaImageBlockParam) =
            apply {
                this.cacheControl = promptCachingBetaImageBlockParam.cacheControl
                this.type = promptCachingBetaImageBlockParam.type
                this.source = promptCachingBetaImageBlockParam.source
                additionalProperties(promptCachingBetaImageBlockParam.additionalProperties)
            }
        ...
        fun build(): PromptCachingBetaImageBlockParam =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PromptCachingBetaImageBlockParam && cacheControl == other.cacheControl && type == other.type && source == other.source && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PromptCachingBetaImageBlockParam{cacheControl=$cacheControl, type=$type, source=$source, additionalProperties=$additionalProperties}"
}
