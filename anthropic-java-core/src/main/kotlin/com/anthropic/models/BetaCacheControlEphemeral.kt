...
@JsonDeserialize(builder = BetaCacheControlEphemeral.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(betaCacheControlEphemeral: BetaCacheControlEphemeral) = apply {
            this.type = betaCacheControlEphemeral.type
            additionalProperties(betaCacheControlEphemeral.additionalProperties)
        }
        ...
        fun build(): BetaCacheControlEphemeral =
            BetaCacheControlEphemeral(type, additionalProperties.toImmutable())
    }
