...
@JsonDeserialize(builder = ToolChoiceAny.Builder::class)
@NoAutoDetect
class ToolChoiceAny
private constructor(
    ...
    class Builder {
        ...
        internal fun from(toolChoiceAny: ToolChoiceAny) = apply {
            this.type = toolChoiceAny.type
            this.disableParallelToolUse = toolChoiceAny.disableParallelToolUse
            additionalProperties(toolChoiceAny.additionalProperties)
        }
