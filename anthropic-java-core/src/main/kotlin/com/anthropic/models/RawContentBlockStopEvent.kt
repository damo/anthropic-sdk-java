...
@JsonDeserialize(builder = RawContentBlockStopEvent.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(rawContentBlockStopEvent: RawContentBlockStopEvent) = apply {
            this.type = rawContentBlockStopEvent.type
            this.index = rawContentBlockStopEvent.index
            additionalProperties(rawContentBlockStopEvent.additionalProperties)
        }
