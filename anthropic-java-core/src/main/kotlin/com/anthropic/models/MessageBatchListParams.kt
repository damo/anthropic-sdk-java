...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [MessageBatchListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MessageBatchListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageBatchListParams: MessageBatchListParams) = apply {
            afterId = messageBatchListParams.afterId
            beforeId = messageBatchListParams.beforeId
            limit = messageBatchListParams.limit
            additionalHeaders = messageBatchListParams.additionalHeaders.toBuilder()
            additionalQueryParams = messageBatchListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): MessageBatchListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatchListParams && afterId == other.afterId && beforeId == other.beforeId && limit == other.limit && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatchListParams{afterId=$afterId, beforeId=$beforeId, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
