...
private constructor(
    ...
    fun toParam(): CitationSearchResultLocationParam =
    ...
    class Builder internal constructor() {
        ...
        internal fun from(citationsSearchResultLocation: CitationsSearchResultLocation) = apply {
            ...
            source = citationsSearchResultLocation.source
            startBlockIndex = citationsSearchResultLocation.startBlockIndex
            title = citationsSearchResultLocation.title
            type = citationsSearchResultLocation.type
            additionalProperties = citationsSearchResultLocation.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): CitationsSearchResultLocation =
            CitationsSearchResultLocation(
    ...
    fun validate(): CitationsSearchResultLocation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "CitationsSearchResultLocation{citedText=$citedText, endBlockIndex=$endBlockIndex, searchResultIndex=$searchResultIndex, source=$source, startBlockIndex=$startBlockIndex, title=$title, type=$type, additionalProperties=$additionalProperties}"
}
