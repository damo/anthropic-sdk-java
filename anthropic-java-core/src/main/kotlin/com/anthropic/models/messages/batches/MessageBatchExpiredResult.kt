...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): MessageBatchExpiredResult =
            MessageBatchExpiredResult(type, additionalProperties.toMutableMap())
    }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = type.let { if (it == JsonValue.from("expired")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageBatchExpiredResult &&
            type == other.type &&
