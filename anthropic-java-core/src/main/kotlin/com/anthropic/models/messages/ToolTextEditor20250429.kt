...
private constructor(
    ...
    /** A builder for [ToolTextEditor20250429]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(toolTextEditor20250429: ToolTextEditor20250429) = apply {
    ...
    fun validate(): ToolTextEditor20250429 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ToolTextEditor20250429 && name == other.name && type == other.type && cacheControl == other.cacheControl && additionalProperties == other.additionalProperties /* spotless:on */
    }
