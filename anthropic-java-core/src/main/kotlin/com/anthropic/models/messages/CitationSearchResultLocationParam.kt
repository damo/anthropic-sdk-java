...
private constructor(
    ...
    /** A builder for [CitationSearchResultLocationParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(citationSearchResultLocationParam: CitationSearchResultLocationParam) =
            apply {
                citedText = citationSearchResultLocationParam.citedText
                endBlockIndex = citationSearchResultLocationParam.endBlockIndex
                searchResultIndex = citationSearchResultLocationParam.searchResultIndex
                source = citationSearchResultLocationParam.source
                startBlockIndex = citationSearchResultLocationParam.startBlockIndex
                title = citationSearchResultLocationParam.title
                type = citationSearchResultLocationParam.type
         ...
         */
        fun build(): CitationSearchResultLocationParam =
            CitationSearchResultLocationParam(
    ...
    fun validate(): CitationSearchResultLocationParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CitationSearchResultLocationParam && citedText == other.citedText && endBlockIndex == other.endBlockIndex && searchResultIndex == other.searchResultIndex && source == other.source && startBlockIndex == other.startBlockIndex && title == other.title && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CitationSearchResultLocationParam{citedText=$citedText, endBlockIndex=$endBlockIndex, searchResultIndex=$searchResultIndex, source=$source, startBlockIndex=$startBlockIndex, title=$title, type=$type, additionalProperties=$additionalProperties}"
}
