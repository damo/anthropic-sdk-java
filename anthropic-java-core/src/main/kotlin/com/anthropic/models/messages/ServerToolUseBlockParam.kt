...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(serverToolUseBlockParam: ServerToolUseBlockParam) = apply {
            id = serverToolUseBlockParam.id
            input = serverToolUseBlockParam.input
            name = serverToolUseBlockParam.name
            type = serverToolUseBlockParam.type
            cacheControl = serverToolUseBlockParam.cacheControl
            additionalProperties = serverToolUseBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ServerToolUseBlockParam =
    ...
    fun validate(): ServerToolUseBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ServerToolUseBlockParam &&
            id == other.id &&
            input == other.input &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "ServerToolUseBlockParam{id=$id, input=$input, name=$name, type=$type, cacheControl=$cacheControl, additionalProperties=$additionalProperties}"
}
