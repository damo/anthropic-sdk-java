...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            encryptedIndex = citationWebSearchResultLocationParam.encryptedIndex
            title = citationWebSearchResultLocationParam.title
            type = citationWebSearchResultLocationParam.type
            url = citationWebSearchResultLocationParam.url
            additionalProperties =
                citationWebSearchResultLocationParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): CitationWebSearchResultLocationParam =
            CitationWebSearchResultLocationParam(
    ...
    fun validate(): CitationWebSearchResultLocationParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CitationWebSearchResultLocationParam && citedText == other.citedText && encryptedIndex == other.encryptedIndex && title == other.title && type == other.type && url == other.url && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CitationWebSearchResultLocationParam{citedText=$citedText, encryptedIndex=$encryptedIndex, title=$title, type=$type, url=$url, additionalProperties=$additionalProperties}"
}
