...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WebSearchResultBlock && encryptedContent == other.encryptedContent && pageAge == other.pageAge && title == other.title && type == other.type && url == other.url && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(encryptedContent, pageAge, title, type, url, additionalProperties) }
    /* spotless:on */
