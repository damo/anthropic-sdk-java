...
private constructor(
    ...
    fun validate(): CacheCreation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "CacheCreation{ephemeral1hInputTokens=$ephemeral1hInputTokens, ephemeral5mInputTokens=$ephemeral5mInputTokens, additionalProperties=$additionalProperties}"
}
