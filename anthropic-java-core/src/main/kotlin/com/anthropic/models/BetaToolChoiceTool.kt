...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(betaToolChoiceTool: BetaToolChoiceTool) = apply {
            this.type = betaToolChoiceTool.type
            this.name = betaToolChoiceTool.name
            this.disableParallelToolUse = betaToolChoiceTool.disableParallelToolUse
            additionalProperties(betaToolChoiceTool.additionalProperties)
        }
