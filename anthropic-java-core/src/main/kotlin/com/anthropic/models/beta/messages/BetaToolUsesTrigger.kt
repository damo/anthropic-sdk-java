...
private constructor(
    ...
    fun validate(): BetaToolUsesTrigger = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolUsesTrigger &&
            type == other.type &&
            value == other.value &&
    ...
    override fun toString() =
        "BetaToolUsesTrigger{type=$type, value=$value, additionalProperties=$additionalProperties}"
}
