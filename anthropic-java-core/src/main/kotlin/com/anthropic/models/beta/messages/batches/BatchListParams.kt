...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchListParams: BatchListParams) = apply {
            ...
            betas = batchListParams.betas?.toMutableList()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatchListParams && afterId == other.afterId && beforeId == other.beforeId && limit == other.limit && betas == other.betas && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "BatchListParams{afterId=$afterId, beforeId=$beforeId, limit=$limit, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
