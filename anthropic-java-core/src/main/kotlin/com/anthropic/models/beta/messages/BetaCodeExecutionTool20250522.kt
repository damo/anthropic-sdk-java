...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): BetaCodeExecutionTool20250522 =
            BetaCodeExecutionTool20250522(
                name,
                type,
                cacheControl,
    ...
    fun validate(): BetaCodeExecutionTool20250522 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "BetaCodeExecutionTool20250522{name=$name, type=$type, cacheControl=$cacheControl, additionalProperties=$additionalProperties}"
}
