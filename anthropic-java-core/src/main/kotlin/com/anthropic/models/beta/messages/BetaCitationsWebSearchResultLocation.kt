...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            citedText = betaCitationsWebSearchResultLocation.citedText
            encryptedIndex = betaCitationsWebSearchResultLocation.encryptedIndex
            title = betaCitationsWebSearchResultLocation.title
            type = betaCitationsWebSearchResultLocation.type
            url = betaCitationsWebSearchResultLocation.url
            additionalProperties =
                betaCitationsWebSearchResultLocation.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaCitationsWebSearchResultLocation =
            BetaCitationsWebSearchResultLocation(
    ...
    fun validate(): BetaCitationsWebSearchResultLocation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "BetaCitationsWebSearchResultLocation{citedText=$citedText, encryptedIndex=$encryptedIndex, title=$title, type=$type, url=$url, additionalProperties=$additionalProperties}"
}
