...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaWebSearchToolRequestError: BetaWebSearchToolRequestError) = apply {
            errorCode = betaWebSearchToolRequestError.errorCode
            type = betaWebSearchToolRequestError.type
            additionalProperties = betaWebSearchToolRequestError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebSearchToolRequestError =
            BetaWebSearchToolRequestError(
    ...
    fun validate(): BetaWebSearchToolRequestError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BetaWebSearchToolRequestError && errorCode == other.errorCode && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
