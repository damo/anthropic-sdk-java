...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(betaCitationContentBlockLocation: BetaCitationContentBlockLocation) =
            apply {
                ...
                fileId = betaCitationContentBlockLocation.fileId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BetaCitationContentBlockLocation && citedText == other.citedText && documentIndex == other.documentIndex && documentTitle == other.documentTitle && endBlockIndex == other.endBlockIndex && fileId == other.fileId && startBlockIndex == other.startBlockIndex && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BetaCitationContentBlockLocation{citedText=$citedText, documentIndex=$documentIndex, documentTitle=$documentTitle, endBlockIndex=$endBlockIndex, fileId=$fileId, startBlockIndex=$startBlockIndex, type=$type, additionalProperties=$additionalProperties}"
}
