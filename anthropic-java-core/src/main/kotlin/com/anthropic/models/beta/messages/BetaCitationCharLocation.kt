...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(betaCitationCharLocation: BetaCitationCharLocation) = apply {
            ...
            fileId = betaCitationCharLocation.fileId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BetaCitationCharLocation && citedText == other.citedText && documentIndex == other.documentIndex && documentTitle == other.documentTitle && endCharIndex == other.endCharIndex && fileId == other.fileId && startCharIndex == other.startCharIndex && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BetaCitationCharLocation{citedText=$citedText, documentIndex=$documentIndex, documentTitle=$documentTitle, endCharIndex=$endCharIndex, fileId=$fileId, startCharIndex=$startCharIndex, type=$type, additionalProperties=$additionalProperties}"
}
