...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            fileId = betaBashCodeExecutionOutputBlockParam.fileId
            type = betaBashCodeExecutionOutputBlockParam.type
            additionalProperties =
                betaBashCodeExecutionOutputBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaBashCodeExecutionOutputBlockParam =
            BetaBashCodeExecutionOutputBlockParam(
    ...
    fun validate(): BetaBashCodeExecutionOutputBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBashCodeExecutionOutputBlockParam &&
            fileId == other.fileId &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaBashCodeExecutionOutputBlockParam{fileId=$fileId, type=$type, additionalProperties=$additionalProperties}"
}
