...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            type = betaTextEditorCodeExecutionToolResultErrorParam.type
            errorMessage = betaTextEditorCodeExecutionToolResultErrorParam.errorMessage
            additionalProperties =
                betaTextEditorCodeExecutionToolResultErrorParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaTextEditorCodeExecutionToolResultErrorParam =
            BetaTextEditorCodeExecutionToolResultErrorParam(
    ...
    fun validate(): BetaTextEditorCodeExecutionToolResultErrorParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaTextEditorCodeExecutionToolResultErrorParam &&
    ...
    override fun toString() =
        "BetaTextEditorCodeExecutionToolResultErrorParam{errorCode=$errorCode, type=$type, errorMessage=$errorMessage, additionalProperties=$additionalProperties}"
}
