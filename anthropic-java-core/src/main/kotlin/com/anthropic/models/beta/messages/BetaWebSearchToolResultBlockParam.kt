...
private constructor(
    private val content: JsonField<BetaWebSearchToolResultBlockParamContent>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        content: JsonField<BetaWebSearchToolResultBlockParamContent> = JsonMissing.of(),
     ...
     */
    fun content(): BetaWebSearchToolResultBlockParamContent = content.getRequired("content")
    ...
    @JsonProperty("content")
    @ExcludeMissing
    fun _content(): JsonField<BetaWebSearchToolResultBlockParamContent> = content
    ...
    class Builder internal constructor() {
        ...
        private var content: JsonField<BetaWebSearchToolResultBlockParamContent>? = null
        ...
        @JvmSynthetic
        internal fun from(betaWebSearchToolResultBlockParam: BetaWebSearchToolResultBlockParam) =
            apply {
                content = betaWebSearchToolResultBlockParam.content
                toolUseId = betaWebSearchToolResultBlockParam.toolUseId
                type = betaWebSearchToolResultBlockParam.type
                cacheControl = betaWebSearchToolResultBlockParam.cacheControl
                additionalProperties =
                    betaWebSearchToolResultBlockParam.additionalProperties.toMutableMap()
            }

        fun content(content: BetaWebSearchToolResultBlockParamContent) =
         ...
         * [BetaWebSearchToolResultBlockParamContent] value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun content(content: JsonField<BetaWebSearchToolResultBlockParamContent>) = apply {
         ...
         */
        fun content(requestError: BetaWebSearchToolRequestError) =
            content(BetaWebSearchToolResultBlockParamContent.ofRequestError(requestError))
         ...
         */
        fun build(): BetaWebSearchToolResultBlockParam =
            BetaWebSearchToolResultBlockParam(
    ...
    fun validate(): BetaWebSearchToolResultBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BetaWebSearchToolResultBlockParam && content == other.content && toolUseId == other.toolUseId && type == other.type && cacheControl == other.cacheControl && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BetaWebSearchToolResultBlockParam{content=$content, toolUseId=$toolUseId, type=$type, cacheControl=$cacheControl, additionalProperties=$additionalProperties}"
}
