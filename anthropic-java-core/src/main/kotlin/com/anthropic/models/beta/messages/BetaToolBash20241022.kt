...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("bash_20241022")
        ...
        fun build(): BetaToolBash20241022 =
            BetaToolBash20241022(name, type, cacheControl, additionalProperties.toMutableMap())
    }
    ...
    fun validate(): BetaToolBash20241022 = apply {
        ...
        _type().let {
            if (it != JsonValue.from("bash_20241022")) {
    ...
    internal fun validity(): Int =
        name.let { if (it == JsonValue.from("bash")) 1 else 0 } +
            type.let { if (it == JsonValue.from("bash_20241022")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolBash20241022 &&
            name == other.name &&
            type == other.type &&
