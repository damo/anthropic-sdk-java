...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): BetaTextDelta =
            BetaTextDelta(checkRequired("text", text), type, additionalProperties.toMutableMap())
    }
    ...
    fun validate(): BetaTextDelta = apply {
        ...
        text()
        _type().let {
            if (it != JsonValue.from("text_delta")) {
