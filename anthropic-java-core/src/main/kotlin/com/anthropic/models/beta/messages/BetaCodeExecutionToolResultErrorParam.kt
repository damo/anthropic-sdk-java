...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            errorCode = betaCodeExecutionToolResultErrorParam.errorCode
            type = betaCodeExecutionToolResultErrorParam.type
            additionalProperties =
                betaCodeExecutionToolResultErrorParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaCodeExecutionToolResultErrorParam =
            BetaCodeExecutionToolResultErrorParam(
    ...
    fun validate(): BetaCodeExecutionToolResultErrorParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaCodeExecutionToolResultErrorParam &&
    ...
    override fun toString() =
        "BetaCodeExecutionToolResultErrorParam{errorCode=$errorCode, type=$type, additionalProperties=$additionalProperties}"
}
