...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("input_tokens")
        private var value: JsonField<Long>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaInputTokensTrigger: BetaInputTokensTrigger) = apply {
            type = betaInputTokensTrigger.type
            value = betaInputTokensTrigger.value
            additionalProperties = betaInputTokensTrigger.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaInputTokensTrigger =
    ...
    fun validate(): BetaInputTokensTrigger = apply {
        if (validated) {
            return@apply
        }

        _type().let {
            if (it != JsonValue.from("input_tokens")) {
    ...
    internal fun validity(): Int =
        type.let { if (it == JsonValue.from("input_tokens")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaInputTokensTrigger &&
            type == other.type &&
            value == other.value &&
    ...
    override fun toString() =
        "BetaInputTokensTrigger{type=$type, value=$value, additionalProperties=$additionalProperties}"
}
