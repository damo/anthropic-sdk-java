...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            errorCode = betaWebFetchToolResultErrorBlockParam.errorCode
            type = betaWebFetchToolResultErrorBlockParam.type
            additionalProperties =
                betaWebFetchToolResultErrorBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebFetchToolResultErrorBlockParam =
            BetaWebFetchToolResultErrorBlockParam(
    ...
    fun validate(): BetaWebFetchToolResultErrorBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebFetchToolResultErrorBlockParam &&
    ...
    override fun toString() =
        "BetaWebFetchToolResultErrorBlockParam{errorCode=$errorCode, type=$type, additionalProperties=$additionalProperties}"
}
