...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): BetaCodeExecutionTool20250825 =
            BetaCodeExecutionTool20250825(
                name,
                type,
                cacheControl,
    ...
    fun validate(): BetaCodeExecutionTool20250825 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "BetaCodeExecutionTool20250825{name=$name, type=$type, cacheControl=$cacheControl, additionalProperties=$additionalProperties}"
}
