...
/**
 * A content block that represents a file to be uploaded to the container Files uploaded via this
...
private constructor(
    ...
    ) : this(fileId, type, cacheControl, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(betaContainerUploadBlockParam: BetaContainerUploadBlockParam) = apply {
            ...
            additionalProperties = betaContainerUploadBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaContainerUploadBlockParam =
            BetaContainerUploadBlockParam(
    ...
    fun validate(): BetaContainerUploadBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BetaContainerUploadBlockParam && fileId == other.fileId && type == other.type && cacheControl == other.cacheControl && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(fileId, type, cacheControl, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaContainerUploadBlockParam{fileId=$fileId, type=$type, cacheControl=$cacheControl, additionalProperties=$additionalProperties}"
}
