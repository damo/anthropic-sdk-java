...
private constructor(
    private val content: JsonField<List<BetaBashCodeExecutionOutputBlock>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        content: JsonField<List<BetaBashCodeExecutionOutputBlock>> = JsonMissing.of(),
    ...
    fun toParam(): BetaBashCodeExecutionResultBlockParam =
     ...
     */
    fun content(): List<BetaBashCodeExecutionOutputBlock> = content.getRequired("content")
    ...
    @JsonProperty("content")
    @ExcludeMissing
    fun _content(): JsonField<List<BetaBashCodeExecutionOutputBlock>> = content
    ...
    class Builder internal constructor() {
        ...
        private var content: JsonField<MutableList<BetaBashCodeExecutionOutputBlock>>? = null
        ...
        internal fun from(betaBashCodeExecutionResultBlock: BetaBashCodeExecutionResultBlock) =
            apply {
                ...
                type = betaBashCodeExecutionResultBlock.type
                additionalProperties =
                    betaBashCodeExecutionResultBlock.additionalProperties.toMutableMap()
            }

        fun content(content: List<BetaBashCodeExecutionOutputBlock>) =
         ...
         * `List<BetaBashCodeExecutionOutputBlock>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun content(content: JsonField<List<BetaBashCodeExecutionOutputBlock>>) = apply {
         ...
         */
        fun addContent(content: BetaBashCodeExecutionOutputBlock) = apply {
            this.content =
         ...
         */
        fun build(): BetaBashCodeExecutionResultBlock =
            BetaBashCodeExecutionResultBlock(
    ...
    fun validate(): BetaBashCodeExecutionResultBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBashCodeExecutionResultBlock &&
    ...
    override fun toString() =
        "BetaBashCodeExecutionResultBlock{content=$content, returnCode=$returnCode, stderr=$stderr, stdout=$stdout, type=$type, additionalProperties=$additionalProperties}"
}
