...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var numLines: JsonField<Long> = JsonMissing.of()
        ...
        internal fun from(
            ...
            content = betaTextEditorCodeExecutionViewResultBlockParam.content
            fileType = betaTextEditorCodeExecutionViewResultBlockParam.fileType
            type = betaTextEditorCodeExecutionViewResultBlockParam.type
            numLines = betaTextEditorCodeExecutionViewResultBlockParam.numLines
            startLine = betaTextEditorCodeExecutionViewResultBlockParam.startLine
            totalLines = betaTextEditorCodeExecutionViewResultBlockParam.totalLines
            additionalProperties =
                betaTextEditorCodeExecutionViewResultBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaTextEditorCodeExecutionViewResultBlockParam =
            BetaTextEditorCodeExecutionViewResultBlockParam(
    ...
    fun validate(): BetaTextEditorCodeExecutionViewResultBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaTextEditorCodeExecutionViewResultBlockParam &&
    ...
    override fun toString() =
        "BetaTextEditorCodeExecutionViewResultBlockParam{content=$content, fileType=$fileType, type=$type, numLines=$numLines, startLine=$startLine, totalLines=$totalLines, additionalProperties=$additionalProperties}"
}
