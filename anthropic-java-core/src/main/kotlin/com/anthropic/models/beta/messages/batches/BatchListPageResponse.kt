...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaMessageBatch>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BetaMessageBatch> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BetaMessageBatch>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<BetaMessageBatch>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaMessageBatch>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<BetaMessageBatch>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BetaMessageBatch] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BetaMessageBatch) = apply {
            this.data =
    ...
    override fun toString() =
        "BatchListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, additionalProperties=$additionalProperties}"
}
