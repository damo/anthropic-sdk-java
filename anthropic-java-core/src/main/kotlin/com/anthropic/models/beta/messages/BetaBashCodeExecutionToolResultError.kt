...
private constructor(
    ...
    fun toParam(): BetaBashCodeExecutionToolResultErrorParam =
        BetaBashCodeExecutionToolResultErrorParam.builder()
            .errorCode(
                _errorCode().map {
                    BetaBashCodeExecutionToolResultErrorParam.ErrorCode.of(it.toString())
                }
            )
            .build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            type = betaBashCodeExecutionToolResultError.type
            additionalProperties =
                betaBashCodeExecutionToolResultError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaBashCodeExecutionToolResultError =
            BetaBashCodeExecutionToolResultError(
    ...
    fun validate(): BetaBashCodeExecutionToolResultError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBashCodeExecutionToolResultError &&
    ...
    override fun toString() =
        "BetaBashCodeExecutionToolResultError{errorCode=$errorCode, type=$type, additionalProperties=$additionalProperties}"
}
