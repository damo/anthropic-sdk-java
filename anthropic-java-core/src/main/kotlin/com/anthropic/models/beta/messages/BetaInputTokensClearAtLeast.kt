...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): BetaInputTokensClearAtLeast =
    ...
    fun validate(): BetaInputTokensClearAtLeast = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaInputTokensClearAtLeast &&
            type == other.type &&
            value == other.value &&
    ...
    override fun toString() =
        "BetaInputTokensClearAtLeast{type=$type, value=$value, additionalProperties=$additionalProperties}"
}
