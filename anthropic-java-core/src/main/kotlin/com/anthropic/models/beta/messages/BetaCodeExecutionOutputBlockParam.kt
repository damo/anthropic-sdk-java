...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(betaCodeExecutionOutputBlockParam: BetaCodeExecutionOutputBlockParam) =
            apply {
                ...
                additionalProperties =
                    betaCodeExecutionOutputBlockParam.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaCodeExecutionOutputBlockParam =
            BetaCodeExecutionOutputBlockParam(
    ...
    fun validate(): BetaCodeExecutionOutputBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BetaCodeExecutionOutputBlockParam && fileId == other.fileId && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BetaCodeExecutionOutputBlockParam{fileId=$fileId, type=$type, additionalProperties=$additionalProperties}"
}
