...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        content: JsonField<List<BetaBashCodeExecutionOutputBlockParam>> = JsonMissing.of(),
     ...
     */
    fun content(): List<BetaBashCodeExecutionOutputBlockParam> = content.getRequired("content")
     ...
     * ```java
     * JsonValue.from("bash_code_execution_result")
     * ```
     *
    ...
    @JsonProperty("content")
    @ExcludeMissing
    fun _content(): JsonField<List<BetaBashCodeExecutionOutputBlockParam>> = content
    ...
    class Builder internal constructor() {
        ...
        private var content: JsonField<MutableList<BetaBashCodeExecutionOutputBlockParam>>? = null
        ...
        internal fun from(
            ...
            type = betaBashCodeExecutionResultBlockParam.type
            additionalProperties =
                betaBashCodeExecutionResultBlockParam.additionalProperties.toMutableMap()
        }

        fun content(content: List<BetaBashCodeExecutionOutputBlockParam>) =
         ...
         * `List<BetaBashCodeExecutionOutputBlockParam>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun content(content: JsonField<List<BetaBashCodeExecutionOutputBlockParam>>) = apply {
         ...
         */
        fun addContent(content: BetaBashCodeExecutionOutputBlockParam) = apply {
            this.content =
        ...
        fun addContent(content: BetaBashCodeExecutionOutputBlock) = addContent(content.toParam())
         ...
         */
        fun build(): BetaBashCodeExecutionResultBlockParam =
            BetaBashCodeExecutionResultBlockParam(
    ...
    fun validate(): BetaBashCodeExecutionResultBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBashCodeExecutionResultBlockParam &&
    ...
    override fun toString() =
        "BetaBashCodeExecutionResultBlockParam{content=$content, returnCode=$returnCode, stderr=$stderr, stdout=$stdout, type=$type, additionalProperties=$additionalProperties}"
}
