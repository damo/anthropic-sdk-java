...
private constructor(
    ...
    fun toParam(): BetaTextEditorCodeExecutionCreateResultBlockParam =
        BetaTextEditorCodeExecutionCreateResultBlockParam.builder()
            .isFileUpdate(_isFileUpdate())
            .build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            isFileUpdate = betaTextEditorCodeExecutionCreateResultBlock.isFileUpdate
            type = betaTextEditorCodeExecutionCreateResultBlock.type
            additionalProperties =
                betaTextEditorCodeExecutionCreateResultBlock.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaTextEditorCodeExecutionCreateResultBlock =
            BetaTextEditorCodeExecutionCreateResultBlock(
    ...
    fun validate(): BetaTextEditorCodeExecutionCreateResultBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaTextEditorCodeExecutionCreateResultBlock &&
    ...
    override fun toString() =
        "BetaTextEditorCodeExecutionCreateResultBlock{isFileUpdate=$isFileUpdate, type=$type, additionalProperties=$additionalProperties}"
}
