...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(betaWebSearchResultBlockParam: BetaWebSearchResultBlockParam) = apply {
            ...
            type = betaWebSearchResultBlockParam.type
            url = betaWebSearchResultBlockParam.url
            pageAge = betaWebSearchResultBlockParam.pageAge
            additionalProperties = betaWebSearchResultBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebSearchResultBlockParam =
            BetaWebSearchResultBlockParam(
    ...
    fun validate(): BetaWebSearchResultBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "BetaWebSearchResultBlockParam{encryptedContent=$encryptedContent, title=$title, type=$type, url=$url, pageAge=$pageAge, additionalProperties=$additionalProperties}"
}
