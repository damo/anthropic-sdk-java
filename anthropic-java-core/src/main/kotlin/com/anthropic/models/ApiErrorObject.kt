...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ApiErrorObject && message == other.message && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ApiErrorObject{message=$message, type=$type, additionalProperties=$additionalProperties}"
}
