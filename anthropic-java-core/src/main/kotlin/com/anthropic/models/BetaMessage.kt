...
private constructor(
    ...
    class Builder {
         ...
         * ```
         */
        fun addContent(betaTextBlock: BetaTextBlock) =
            addContent(BetaContentBlock.ofBetaTextBlock(betaTextBlock))
         ...
         * ```
         */
        fun addContent(betaToolUseBlock: BetaToolUseBlock) =
            addContent(BetaContentBlock.ofBetaToolUseBlock(betaToolUseBlock))
