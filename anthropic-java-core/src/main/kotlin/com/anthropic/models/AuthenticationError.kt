...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(authenticationError: AuthenticationError) = apply {
            ...
            additionalProperties(authenticationError.additionalProperties)
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AuthenticationError && type == other.type && message == other.message && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "AuthenticationError{type=$type, message=$message, additionalProperties=$additionalProperties}"
}
