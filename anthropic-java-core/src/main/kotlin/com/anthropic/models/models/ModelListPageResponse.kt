...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<ModelInfo>> = JsonMissing.of(),
     ...
     */
    fun data(): List<ModelInfo> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ModelInfo>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ModelInfo>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<ModelInfo>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<ModelInfo>>) = apply {
         ...
         */
        fun addData(data: ModelInfo) = apply {
            this.data =
