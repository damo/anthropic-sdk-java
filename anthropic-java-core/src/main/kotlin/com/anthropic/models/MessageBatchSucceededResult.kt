...
@JsonDeserialize(builder = MessageBatchSucceededResult.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(messageBatchSucceededResult: MessageBatchSucceededResult) = apply {
            this.type = messageBatchSucceededResult.type
            this.message = messageBatchSucceededResult.message
            additionalProperties(messageBatchSucceededResult.additionalProperties)
        }
