...
@JsonDeserialize(builder = PromptCachingBetaTool.Builder::class)
@NoAutoDetect
class PromptCachingBetaTool
private constructor(
    ...
    fun validate(): PromptCachingBetaTool = apply {
        if (!validated) {
            description()
            name()
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(promptCachingBetaTool: PromptCachingBetaTool) = apply {
            this.description = promptCachingBetaTool.description
            this.name = promptCachingBetaTool.name
            this.inputSchema = promptCachingBetaTool.inputSchema
            this.cacheControl = promptCachingBetaTool.cacheControl
            additionalProperties(promptCachingBetaTool.additionalProperties)
        }
        ...
        fun build(): PromptCachingBetaTool =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PromptCachingBetaTool && description == other.description && name == other.name && inputSchema == other.inputSchema && cacheControl == other.cacheControl && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PromptCachingBetaTool{description=$description, name=$name, inputSchema=$inputSchema, cacheControl=$cacheControl, additionalProperties=$additionalProperties}"
}
