...
@JsonDeserialize(builder = PromptCachingBetaUsage.Builder::class)
@NoAutoDetect
class PromptCachingBetaUsage
private constructor(
    ...
    fun validate(): PromptCachingBetaUsage = apply {
        if (!validated) {
            inputTokens()
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(promptCachingBetaUsage: PromptCachingBetaUsage) = apply {
            this.inputTokens = promptCachingBetaUsage.inputTokens
            this.cacheCreationInputTokens = promptCachingBetaUsage.cacheCreationInputTokens
            this.cacheReadInputTokens = promptCachingBetaUsage.cacheReadInputTokens
            this.outputTokens = promptCachingBetaUsage.outputTokens
            additionalProperties(promptCachingBetaUsage.additionalProperties)
        }
        ...
        fun build(): PromptCachingBetaUsage =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PromptCachingBetaUsage && inputTokens == other.inputTokens && cacheCreationInputTokens == other.cacheCreationInputTokens && cacheReadInputTokens == other.cacheReadInputTokens && outputTokens == other.outputTokens && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PromptCachingBetaUsage{inputTokens=$inputTokens, cacheCreationInputTokens=$cacheCreationInputTokens, cacheReadInputTokens=$cacheReadInputTokens, outputTokens=$outputTokens, additionalProperties=$additionalProperties}"
}
