...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ToolUnion && bash20250124 == other.bash20250124 && textEditor20250124 == other.textEditor20250124 && tool == other.tool /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(bash20250124, textEditor20250124, tool) /* spotless:on */
