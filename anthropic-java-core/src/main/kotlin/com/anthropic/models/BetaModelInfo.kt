...
@JsonDeserialize(builder = BetaModelInfo.Builder::class)
@NoAutoDetect
class BetaModelInfo
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BetaModelInfo && type == other.type && id == other.id && displayName == other.displayName && createdAt == other.createdAt && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BetaModelInfo{type=$type, id=$id, displayName=$displayName, createdAt=$createdAt, additionalProperties=$additionalProperties}"
}
