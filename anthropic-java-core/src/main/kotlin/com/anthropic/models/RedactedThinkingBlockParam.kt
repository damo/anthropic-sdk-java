...
private constructor(
    ...
    fun validate(): RedactedThinkingBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    class Builder internal constructor() {
        ...
        fun build(): RedactedThinkingBlockParam =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is RedactedThinkingBlockParam && data == other.data && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "RedactedThinkingBlockParam{data=$data, type=$type, additionalProperties=$additionalProperties}"
}
