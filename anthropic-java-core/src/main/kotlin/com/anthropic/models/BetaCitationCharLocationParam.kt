...
private constructor(
    ...
    fun validate(): BetaCitationCharLocationParam = apply {
        if (validated) {
            return@apply
        }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaCitationCharLocationParam: BetaCitationCharLocationParam) = apply {
            citedText = betaCitationCharLocationParam.citedText
            documentIndex = betaCitationCharLocationParam.documentIndex
            documentTitle = betaCitationCharLocationParam.documentTitle
            endCharIndex = betaCitationCharLocationParam.endCharIndex
            startCharIndex = betaCitationCharLocationParam.startCharIndex
            type = betaCitationCharLocationParam.type
            additionalProperties = betaCitationCharLocationParam.additionalProperties.toMutableMap()
        }
        ...
        fun build(): BetaCitationCharLocationParam =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BetaCitationCharLocationParam && citedText == other.citedText && documentIndex == other.documentIndex && documentTitle == other.documentTitle && endCharIndex == other.endCharIndex && startCharIndex == other.startCharIndex && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BetaCitationCharLocationParam{citedText=$citedText, documentIndex=$documentIndex, documentTitle=$documentTitle, endCharIndex=$endCharIndex, startCharIndex=$startCharIndex, type=$type, additionalProperties=$additionalProperties}"
}
