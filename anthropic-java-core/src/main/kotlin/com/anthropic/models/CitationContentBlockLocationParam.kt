...
private constructor(
    ...
    fun validate(): CitationContentBlockLocationParam = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [CitationContentBlockLocationParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(citationContentBlockLocationParam: CitationContentBlockLocationParam) =
            apply {
                citedText = citationContentBlockLocationParam.citedText
                documentIndex = citationContentBlockLocationParam.documentIndex
                documentTitle = citationContentBlockLocationParam.documentTitle
                endBlockIndex = citationContentBlockLocationParam.endBlockIndex
                startBlockIndex = citationContentBlockLocationParam.startBlockIndex
                type = citationContentBlockLocationParam.type
        ...
        fun build(): CitationContentBlockLocationParam =
    ...
    override fun toString() =
        "CitationContentBlockLocationParam{citedText=$citedText, documentIndex=$documentIndex, documentTitle=$documentTitle, endBlockIndex=$endBlockIndex, startBlockIndex=$startBlockIndex, type=$type, additionalProperties=$additionalProperties}"
}
