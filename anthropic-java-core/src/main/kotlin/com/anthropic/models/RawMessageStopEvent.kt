...
@JsonDeserialize(builder = RawMessageStopEvent.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(rawMessageStopEvent: RawMessageStopEvent) = apply {
            this.type = rawMessageStopEvent.type
            additionalProperties(rawMessageStopEvent.additionalProperties)
        }
