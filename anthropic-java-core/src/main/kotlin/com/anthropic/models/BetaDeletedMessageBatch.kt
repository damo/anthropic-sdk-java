...
@JsonDeserialize(builder = BetaDeletedMessageBatch.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(betaDeletedMessageBatch: BetaDeletedMessageBatch) = apply {
            this.id = betaDeletedMessageBatch.id
            this.type = betaDeletedMessageBatch.type
            additionalProperties(betaDeletedMessageBatch.additionalProperties)
        }
