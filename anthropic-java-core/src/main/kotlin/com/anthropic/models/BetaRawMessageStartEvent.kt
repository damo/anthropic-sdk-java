...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(betaRawMessageStartEvent: BetaRawMessageStartEvent) = apply {
            this.type = betaRawMessageStartEvent.type
            this.message = betaRawMessageStartEvent.message
            additionalProperties(betaRawMessageStartEvent.additionalProperties)
        }
