...
@JsonDeserialize(builder = MessageParam.Builder::class)
@NoAutoDetect
class MessageParam
private constructor(
    ...
    class Builder {
        ...
        internal fun from(messageParam: MessageParam) = apply {
            this.role = messageParam.role
            this.content = messageParam.content
            additionalProperties(messageParam.additionalProperties)
        }
