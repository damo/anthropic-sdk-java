...
private constructor(
    ...
    class Builder {
        ...
        private var requestCounts: JsonField<MessageBatchRequestCounts> = JsonMissing.of()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageBatch && id == other.id && type == other.type && processingStatus == other.processingStatus && requestCounts == other.requestCounts && endedAt == other.endedAt && createdAt == other.createdAt && expiresAt == other.expiresAt && archivedAt == other.archivedAt && cancelInitiatedAt == other.cancelInitiatedAt && resultsUrl == other.resultsUrl && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageBatch{id=$id, type=$type, processingStatus=$processingStatus, requestCounts=$requestCounts, endedAt=$endedAt, createdAt=$createdAt, expiresAt=$expiresAt, archivedAt=$archivedAt, cancelInitiatedAt=$cancelInitiatedAt, resultsUrl=$resultsUrl, additionalProperties=$additionalProperties}"
}
