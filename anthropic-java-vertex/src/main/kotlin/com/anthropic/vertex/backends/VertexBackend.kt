 ...
 *
 * See the Google Cloud documentation for details on how to configure Google
 * credentials.
 */
class VertexBackend private constructor(
    ...
    /**
     * A builder for a [VertexBackend] used to connect an Anthropic client to an
     * Anthropic model on the Google Cloud Vertex AI backend service.
     *
